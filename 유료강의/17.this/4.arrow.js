...
// cat.play is not a constructor 뜸

/**
 //* 화살표 함수의 특징
 *! 1. 문법이 깔끔함
 *! 2. 생성자 함수로 사용이 불가능 (무거운 프로토타입을 만들지 ❌)
 *! 3. 함수 자체 arguments 도 가지고 있지 않다.
...
const add = (a, b) => {
  ...
  // arrow 함수 외부의 전역객체의 arguments를 참조만 함, log 엄청 많다
};
add(1, 2);
